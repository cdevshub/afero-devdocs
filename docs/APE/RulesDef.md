...
2. Click +RULE. The rule definition editor opens:![Create New Rule](https://developer.afero.io/static/custom/images/NewRule.png)
...
5. 1. In the right-hand NOTIFICATIONS pane, select + NOTIFICATION. The New Notification window opens:![Create New Notification](https://developer.afero.io/static/custom/images/NewNotification.png)
   ...
   5. If you have a notification you’ve already defined, you can use it as a template for a new one by selecting the duplicate icon:![img](https://developer.afero.io/static/custom/images/DupNotification.png)
...
Delete a Rule - Locate the rule you want to delete, then click the trash icon:![Trash Icon](https://developer.afero.io/static/custom/images/TrashIconWhite.png). You’ll be asked to confirm.

Edit a Notification - Locate the notification you want to edit, then click the pencil icon ![Pencil Icon](https://developer.afero.io/static/custom/images/PencilIconWhite.png). Make your edits, then click SAVE.

Duplicate a Notification - Locate the notification you want to duplicate and click the duplicate icon![img](https://developer.afero.io/static/custom/images/DupIcon.png), located on the right. A new notification window opens using the Description and Message from the original notification. Make your edits, then click SAVE.

 Next: [Publish Your Profile](https://developer.afero.io/Publish)