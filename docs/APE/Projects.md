...
- [Select the Project](https://developer.afero.io/SelectProject)
- [Define the Device Type](https://developer.afero.io/DeviceType)
- [Define the Device Attributes](https://developer.afero.io/AttrDef)
- [Define the Mobile App UI](https://developer.afero.io/AppUIDef)
- [Publish Your Profile](https://developer.afero.io/Publish)

Before you start, read the next few sections to get an introduction to Device Types, device Profiles, and the Afero Profile Editor in general. You are also encouraged to step through [Tutorial 2: Creating a Device Profile](https://developer.afero.io/Lesson2) before creating your own device Profile.
...
![Project Structure](https://developer.afero.io/static/custom/images/APE-ProjectStructure.png)
...
Avoid making edits directly on project files with tools other than the Afero Profile Editor. If you do, normal consistency checks and validation are bypassed, which could cause unexpected results.
 ...
 Next: [Select the Project](https://developer.afero.io/SelectProject)