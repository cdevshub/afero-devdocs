...
| :--- | :----------------------------------------------------------- | :----------------------------------------------------------- | :-------------------------------- |
| ☐    | Submit partner email, final device Profile version #, and Device Type Name to Program Manager. | This is the information you’ve gathered above in [Step 1](https://developer.afero.io/FactoryProg#AFP-Requirements). | PartnerAfero Program Manager (PM) |
...
- [6.1 Validate QR Codes and BLE RSSI Levels](https://developer.afero.io/FactoryProg#BLEtest)
- [6.2 Validate QR Codes and BLE+Wi-Fi RSSI Levels](https://developer.afero.io/FactoryProg#BLE+WiFitest)
