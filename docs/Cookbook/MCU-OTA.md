...
In the [previous topic](https://developer.afero.io/RebootRequests), we looked at how ASR can receive an over-the-air (OTA) firmware update, and should be ready to handle the update by rebooting once the update is complete.
...
- You’ll use the Afero OTA Manager to [deploy a firmware image](https://developer.afero.io/OTAMgr#DeployFWImage) to your device.
