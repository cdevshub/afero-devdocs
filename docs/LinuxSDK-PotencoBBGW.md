...
**11.** To flash the image, use the directions in [Install and Boot the Potenco Operating System](../LinuxSDK-PotencoBBGW#install-and-boot-the-potenco-operating-system). The SD image file you want is in the following file location:
