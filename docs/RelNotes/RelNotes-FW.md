...
- New reboot reason format. Read more in [Device Attribute Registry > Attribute 65019](https://developer.afero.io/AttrRegistry#RebootReason).
- Bug fixes.
...
- Changed the MCU UTC time update to fire **on** the minute. Read more in [Using the Afero Cloud to Keep Time on the MCU](https://developer.afero.io/SetMCUTime).
...
- API added to support MCU over-the-air (OTA) firmware updates. Read more in [Handling MCU OTA Updates](https://developer.afero.io/MCU_OTA).
- New version of [afLib](http://github.com/aferodeveloper/afLib) is available, called afLib3. Read more in [afLib Release Notes](https://developer.afero.io/RelNotes-afLib) and [afLib3 API](https://developer.afero.io/API-afLib).
...
- Added Update state and reasons to the [Device Attribute Message Protocol](https://developer.afero.io/AttrMsgProtocol).
- New version of [afLib](http://github.com/aferodeveloper/afLib) is available, called afLib2. We’ve improved the sample code and included the example application, **aflib_time_check**. Read more in [Using the Afero Cloud to Keep Time on the MCU](https://developer.afero.io/SetMCUTime).
