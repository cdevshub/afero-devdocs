...
- [Caveats and Considerations](https://developer.afero.io/StandaloneHub#HubbyCaveats)

- [Hardware Requirements](https://developer.afero.io/StandaloneHub#HubbyHWReqs)

- [Set Up the Raspberry Pi](https://developer.afero.io/StandaloneHub#RaspPiSetup)

- [Install the Afero Hub Software](https://developer.afero.io/StandaloneHub#HubbyInstallOptions)

- - [Install the Hub Software via APT Repository (Recommended)](https://developer.afero.io/StandaloneHub#HubbyInstallAPT)
  - [Install the Hub Software Manually](https://developer.afero.io/StandaloneHub#HubbyManPkgInstall)

- [Add the Virtual-Hub Device to Your Account](https://developer.afero.io/StandaloneHub#HubbyConfigure)

- [Manage the Afero Hub Software](https://developer.afero.io/StandaloneHub#HubbyManage)

- - [Start, Stop, and Restart the Hub Software](https://developer.afero.io/StandaloneHub#HubbyStartStopRestart)
  - [Manage the Virtual-Hub Device](https://developer.afero.io/StandaloneHub#HubbyVirtualDevice)
  - [Remove, Reinstall, and Update the Hub Software](https://developer.afero.io/StandaloneHub#HubbyRemoveEtc)

- [Get Support](https://developer.afero.io/StandaloneHub#HubbySupport)
...
You can install the Afero Hub Software in either of two ways. The first, [via APT repository](https://developer.afero.io/StandaloneHub#HubbyInstallAPT), is recommended. The second, [manual install](https://developer.afero.io/StandaloneHub#HubbyManPkgInstall), is there if you need it.
...
3. Skip down to [Add the Virtual-Hub Device to Your Account](https://developer.afero.io/StandaloneHub#HubbyConfigure) to continue.
...
4. Continue with [Add the Virtual-Hub Device to Your Account](https://developer.afero.io/StandaloneHub#HubbyConfigure).
