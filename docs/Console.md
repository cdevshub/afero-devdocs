...
The Console is easy to use and self-documenting. A description of the user interface is presented on this page. Be sure to refer to the [Glossary](https://afero-devdocs.readthedocs.io/en/latest/Glossary) for term definitions when using the Console.
...
- [Real-Time Activity](https://afero-devdocs.readthedocs.io/en/latest/Console#RTActivity)
- [Device Listing](https://afero-devdocs.readthedocs.io/en/latest/Console#DevListing) and [Individual Device Data Viewer](https://afero-devdocs.readthedocs.io/en/latest/Console#DeviceDataViewer)
- [Device Type Reports](https://afero-devdocs.readthedocs.io/en/latest/Console#DTReports)
- [Data Explorer](https://afero-devdocs.readthedocs.io/en/latest/Console#DataExpl)
- [Platform Usage](https://afero-devdocs.readthedocs.io/en/latest/Console#PlatUse)
- [Platform Status](https://afero-devdocs.readthedocs.io/en/latest/Console#PltStatus)
- [User Manager](https://afero-devdocs.readthedocs.io/en/latest/Console#UsrMgr)
...
In the table titled YOUR AFERO POWERED DEVICE LISTING, click a Device ID to open the [Device Data Viewer](https://afero-devdocs.readthedocs.io/en/latest/Console#DeviceDataViewer), or click a DEVICE TYPE NAME to go to the relevant [Device Type Reports](https://afero-devdocs.readthedocs.io/en/latest/Console#DTReports) window.
...
- [Device Type Status](https://afero-devdocs.readthedocs.io/en/latest/Console#DevicesOnline)
- [Attribute Usage Breakdown](https://afero-devdocs.readthedocs.io/en/latest/Console#AttrUsageBkdn)
- [Attribute Value Breakdown](https://afero-devdocs.readthedocs.io/en/latest/Console#AttrValueBkdn)
- [Relative Associated Device Distribution](https://afero-devdocs.readthedocs.io/en/latest/Console#RelAssocDevDistr)
- [Cumulative Device Association Trend](https://afero-devdocs.readthedocs.io/en/latest/Console#CumDevAssoc)
- [Application Version Breakdown](https://afero-devdocs.readthedocs.io/en/latest/Console#AppVerBkdn)
- [Connection Type Breakdown](https://afero-devdocs.readthedocs.io/en/latest/Console#ConnTypeBkdn)
...
- - Total monthly message count
  - Total unique [active devices](https://afero-devdocs.readthedocs.io/en/latest/Console#ActiveDevDef)
