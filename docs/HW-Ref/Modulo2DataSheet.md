...
- [Introduction](https://developer.afero.io/Modulo2DataSheet#Intro)
- [Mechanical Specification](https://developer.afero.io/Modulo2DataSheet#MechSpec)
- [DC Electrical Specification](https://developer.afero.io/Modulo2DataSheet#DCSpec)
- [RF Electrical Specification](https://developer.afero.io/Modulo2DataSheet#RFSpec)
- [Environmental Specification](https://developer.afero.io/Modulo2DataSheet#EnvSpec)
- [Ordering Information](https://developer.afero.io/Modulo2DataSheet#OrderInfo)
- [Compliance Notices](https://developer.afero.io/Modulo2DataSheet#Compliance)
...
![img](https://developer.afero.io/static/custom/images/Mod2Block1.png)

## Mechanical Specification

### Mechanical Drawing

![img](https://developer.afero.io/static/custom/images/Modulo-2MechDrawingRevA.png)

### Antenna Keepout

![img](https://developer.afero.io/static/custom/images/Modulo2AntennaKeepout.png)
...
![img](https://developer.afero.io/static/custom/images/Mod2_MarkUp.jpg)
...
View letter stating [EU Declaration of Conformity (pdf)](https://developer.afero.io/static/custom/files/Modulo2-EU-Decl-Conform.pdf).
...
This product has been supplied from an environmentally aware manufacturer that complies with the Waste Electrical and Electronic Equipment (WEEE) Directive 2002/96/EC. The “crossed-out wheelie bin” symbol is placed on this product to encourage you to recycle wherever possible.
 ...
 Next: [ASR-2 Hardware Integration Guide](https://developer.afero.io/ASR2HWInt)