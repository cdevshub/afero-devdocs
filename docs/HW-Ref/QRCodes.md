...
- [Labeling Afero Products with QR Codes](https://developer.afero.io/QRCodes#QR-Code-Labeling)

- - [Large QR Code Labels](https://developer.afero.io/QRCodes#LargeQRCode)
  - [Small QR Code Labels](https://developer.afero.io/QRCodes#SmallQRCode)
  - [Manufacturing Process](https://developer.afero.io/QRCodes#QRCodeManufacturing)
  - [Notes on Label Placement](https://developer.afero.io/QRCodes#LabelPlacement)
  - [Customizing the Label for Printing](https://developer.afero.io/QRCodes#CustomLabel)

- [Generating QR Codes for Afero Products](https://developer.afero.io/QRCodes#QRCodeGen)

- - [Products Using the Latest QR Code Version](https://developer.afero.io/QRCodes#ASR2QR)

  - - [QR Payload Details](https://developer.afero.io/QRCodes#QRPayload)
    - [QR Code Details](https://developer.afero.io/QRCodes#QRParameters)
    - [Plain-Text Association ID](https://developer.afero.io/QRCodes#PlainTextAssnID)
    - [Examples](https://developer.afero.io/QRCodes#ASR2QRcodeExample)

  - [Products Using the Legacy QR Code Version](https://developer.afero.io/QRCodes#ASR1QR)

  - - [About ASR-1 Association ID](https://developer.afero.io/QRCodes#AboutASR-1QRCodes)
    - [Label Printing](https://developer.afero.io/QRCodes#ASR1QRLabeling)
    - [Examples](https://developer.afero.io/QRCodes#ASR1QRcodeExample)

## Labeling Afero Products with QR Codes

Each Afero smart product requires two QR code labels:

- A customer-visible QR code label on the product, described further in [Large QR code Label](https://developer.afero.io/QRCodes#LargeQRCode) below.
- A smaller QR code label on the PCB, described further in [Small QR Code Label](https://developer.afero.io/QRCodes#SmallQRCode), also below.
...
![Example of Large QR Code Label](https://developer.afero.io/static/custom/images/QRCode-Large.png)
...
![Example of Small QR Code Label](https://developer.afero.io/static/custom/images/QRCode-Small.png)
...
- Any changes from Afero standard requires writing updated Zebra printer language for the new label layout/size. Read the next section, [Customizing the Label for Printing](https://developer.afero.io/QRCodes#CustomLabel), for details.

For more technical details of our QR codes, read the section below, [Generating QR Codes for Afero Products](https://developer.afero.io/QRCodes#QRCodeGen).
...
- [Products using the latest QR code version](https://developer.afero.io/QRCodes#ASR2QR), and
- [Products containing the legacy QR code version](https://developer.afero.io/QRCodes#ASR1QR)
...
| ------------------------------------- | ------------------------------------------------------------ |
| **Example QR Code**                   | ![Example QR Code](https://developer.afero.io/static/custom/images/BigAssnQRcode.png) |
| **Example Plain Text Association ID** | ABCD-EF12-3456-7890-ABCD-EF12                                |
| **Example Label**                     | ![Example Label](https://developer.afero.io/static/custom/images/BigAssnQRcodeLabel.png) |
...
![Example QR Codes for ASR-1](https://developer.afero.io/static/custom/images/ASR1-ExampleQRcodes.png)



 Next: [Hardware Design Files](https://developer.afero.io/Datasheets)