...
Ordering information is provided below in the [Key Components List](https://developer.afero.io/ASR2HWInt#key-comps) section.

## Components

The block diagram below illustrates the components required for this integration:

![img](https://developer.afero.io/static/custom/images/Murata-Components-BlockDiag.jpg)
...
Afero designed the following reference schematic with Murata. (Click to open a [.pdf file of the schematic](https://developer.afero.io/static/custom/files/1LD_Afero_20181023.pdf).)

![img](https://developer.afero.io/static/custom/images/1LD_Afero_20181023.png)
...
| SPI flash memory                                             | Winbond      | SPI   | 1        | W25Q32JVSSIQ    | [Digi-Key](https://www.digikey.com/product-detail/en/winbond-electronics/W25Q32JVSSIQ-TR/W25Q32JVSSIQCT-ND/7393546) |
 ...
 Next: [QR Codes for Afero Products](https://developer.afero.io/QRCodes)