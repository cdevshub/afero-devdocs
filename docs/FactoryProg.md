...
- [Prerequisite Tasks](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#Prerequisites)
- [Factory Programmer Block Diagram](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#BlockDiagram)

The Steps

- [1. Gather Factory Programmer Requirements](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#AFP-Requirements)
- [2. Request Factory Programmer from Afero](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#RequestAFP)
- [3. Set Up Hardware/Software for Factory](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#FactorySetup)
- [4. Program Devices at Factory](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#Program)
- [5. Print Product Labels](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#PrintLabels)
- [6. Run Validation Tests](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#Validate)
...
| :--- | :----------------------------------------------------------- | :----------------------------------------------------------- | :-------------------------------- |
| ☐    | Submit partner email, final device Profile version #, and Device Type Name to Program Manager. | This is the information you’ve gathered above in [Step 1](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#AFP-Requirements). | PartnerAfero Program Manager (PM) |
...
- [4.1 Set Up Factory Programming Station(s)](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#FactoryStations)
- [4.2 Program ASR Modules Using Afero Factory Programmer](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#ProgramASR)
- [4.3 Program the Host MCU](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#ProgramMCU)
- [4.4 Register Device(s) with the Afero Cloud](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#RegisterDevices)
...
- [6.1 Validate QR Codes and BLE RSSI Levels](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#BLEtest)
- [6.2 Validate QR Codes and BLE+Wi-Fi RSSI Levels](https://afero-devdocs.readthedocs.io/en/latest/FactoryProg#BLE+WiFitest)
...
| ☐    | Afero Cloud validation.                            | Afero validates the contents of the `.afero` files and confirms partner PCBs have already been ingested into the Afero Cloud by double-checking against the `.afero` files uploaded after factory programming. | Afero                           |
 ...
 Next: [Customize QR Code Labels](https://afero-devdocs.readthedocs.io/en/latest/CustomizeLabel)