...
- [About BitBake Layers](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#aboutlayers)
- [Prerequisites](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#prereqs)
- The Steps
  - [Step 1. Have Your Potenco Build Image](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step1)
  - [Step 2. Create af-app Directory](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step2)
  - [Step 3. Add Source File](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step3)
  - [Step 4. Create the makefile](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step4)
  - [Step 5. Create the BitBake Layer](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step5)
  - [Step 6. Create the BitBake Recipe for the App](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step6)
  - [Step 7. Create the layer.conf File](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step7)
  - [Step 8. Modify bblayers.conf File](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step8)
  - [Step 9. Build Application](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step9)
  - [Step 10. Flash or Copy App Image to Target Device](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step10)
  - [Step 11. Create and Publish Device Profile](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step11)
  - [Step 12. Open the App on the Device](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#step12)
- [Using the Ready-Made Example App](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2App#exapp)
...
- You have completed the instructions for building the Atmel SAMA5D2 based Potenco project, contained in the section [Build the Potenco OS Image](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2#bldpotosimage).
...
Again, be sure you have created a Potenco build image per the instructions in [Build the Potenco OS Image](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2#bldpotosimage). This will be both the core image that is used on the Atmel SAMA5D2 and the image to which you will add your own application code.
...
6. Take the resulting `afimg` file, and flash it onto the SAMA5D2 board using the method outlined in the [Afero Potenco Setup Guide for SAMA5D2 Board > Flash the SAMA5D2 Image](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2#flash).
...
Now you are ready to flash the image to the internal eMMC. Take the resulting `afimg` file and flash it onto the SAMA5D2 board using the method outlined in the [Potenco Setup Guide for SAMA5D2](https://developer.afero.io/LinuxSDK-PotencoSAMA5D2#flash).

 Next: [Secure Linux SDK Frequently-Asked Questions](https://developer.afero.io/LinuxSDK-FAQ)