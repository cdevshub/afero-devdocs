...
3. Once you’ve defined the Device Type, you’ll want to save the definition.
 ...
 Next: [Define the Device Attributes](https://afero-devdocs.readthedocs.io/en/latest/AttrDef)