...
| 7    | LLLLGGRRTTTTSSUUNNNN |                | Update Attribute Header  | •LLLL = NNNN + 8 •GG = 0x0D •RR = Ignore •TTTT = Attribute ID (if !=0xF5FD, then discard) •SS = 0x00 •UU = Ignore •NNNN = Length of Attribute Data | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "TTTT" and "NNNN". |
| 8    | V…                   |                | Set Attribute Data       | NNNN Bytes of Attribute Data                                 | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "V…". |
...
| 6    | 0x32                         |                      | Sync Complete            |                                                              |                                                              |
| 7    | LLLLGGRRTTTTNNNN             |                      | Set Attribute Header     | •LLLL = NNNN + 6 •GG = 0x0B •RR = Ignore •TTTT = Attribute ID •NNNN = Length of Attribute Data | Discard any message with GG!=0x0B. See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "TTTT" and "NNNN". |
| 8    | V…                           |                      | Set Attribute Data       | NNNN Bytes of Attribute Data                                 | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "V…". |
...
| 16   |                              | LLLLGGQQTTTTSSUUNNNN | Update Attribute Header  | •LLLL = NNNN + 8 •GG = 0x0D •QQ = RR (from row 7 above) •TTTT = Attribute ID •SS = 0x00 (success) or 0x05 (failure) •UU = 0x02 •NNNN = Length of Attribute Data | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "TTTT" and "NNNN". |
| 17   |                              | V…                   | Update Attribute Data    | NNNN bytes of Attribute Data                                 | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "V…". |
...
| 6    |                | LLLLGGRRTTTTSSUUNNNN | Update Attribute Header  | •LLLL = NNNN + 8 •GG = 0x0D •RR = 0x00 •TTTT = Attribute ID •SS = 0x00 •UU = 0x01 •NNNN = Length of Attribute Data | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "TTTT" and "NNNN". |
| 7    |                | V…                   | Update Attribute Data    | NNNN Bytes of Attribute Data                                 | See [Attribute Data](https://developer.afero.io/afPro-UART-S#AttrData) below for details of "V…". |
