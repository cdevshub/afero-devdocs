...
This sequence forces ASR to start from a known (initial) state. ASR will initiate the zero sync right after it reboots, as described below in [Example 1](https://developer.afero.io/afPro-SPI#SPI-ZeroSync).
...
- [Example 1: Zero Sync](https://developer.afero.io/afPro-SPI#SPI-ZeroSync) - Occurs when the master sends a Sync Request to the slave, but the data payload is empty. For example, when the master boots, it sends a zero Sync Request to the slave.
- [Example 2: Set Attribute](https://developer.afero.io/afPro-SPI#SPI-SetAttr) - Occurs when the master sets the value of an attribute.
- [Example 3: Update Attribute](https://developer.afero.io/afPro-SPI#SPI-UpdateAttr) - Occurs when the MCU changes the value of an attribute and sends the update back to ASR.
- [Example 4: Set Attribute with Collision](https://developer.afero.io/afPro-SPI#SPI-Collision) - Occurs when the master and slave both want to send a request.
...
![Zero Sync Overview](https://developer.afero.io/static/custom/images/SPI-ZeroSync-Overview.jpg)](https://developer.afero.io/static/custom/images/SPI-ZeroSync-Overview.jpg)
...
[*Click image to enlarge:*
![Zero Sync Request](https://developer.afero.io/static/custom/images/SPI-ZeroSync-Request.jpg)](https://developer.afero.io/static/custom/images/SPI-ZeroSync-Request.jpg)
...
[*Click image to enlarge:*
![Zero Sync Acknowledge](https://developer.afero.io/static/custom/images/SPI-ZeroSync-Ack.jpg)](https://developer.afero.io/static/custom/images/SPI-ZeroSync-Ack.jpg)
...
[*Click image to enlarge:*
![Set MCU From Service Overview](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-Overview.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-Overview.jpg)
...
[*Click image to enlarge:*
![Set MCU From Service Receive Request](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-RecvRequest.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-RecvRequest.jpg)
...
[*Click image to enlarge:*
![Set MCU From Service Receive Acknowledge](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-RecvAck.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-RecvAck.jpg)
...
[*Click image to enlarge:*
![Set MCU From Service Receive Data](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-RecvData.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-RecvData.jpg)
...
[*Click image to enlarge:*
![Set MCU From Service Send Request](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-SendRequest.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-SendRequest.jpg)

Next is the Sync Acknowledge message:

[*Click image to enlarge:*
![Set MCU From Service Send Acknowledge](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-SendAck.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-SendAck.jpg)
...
[*Click image to enlarge:*
![Set MCU From Service Send Data](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-SendData.jpg)](https://developer.afero.io/static/custom/images/SPI-SetMCUFromService-SendData.jpg)
...
[*Click image to enlarge:*
![Collision](https://developer.afero.io/static/custom/images/SPI-Collision.jpg)](https://developer.afero.io/static/custom/images/SPI-Collision.jpg)
...
[*Click image to enlarge:*
![Collision Resync](https://developer.afero.io/static/custom/images/SPI-CollisionResync.jpg)](https://developer.afero.io/static/custom/images/SPI-CollisionResync.jpg)
