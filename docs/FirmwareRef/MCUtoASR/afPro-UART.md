...
This sequence forces ASR to start from a known (initial) state. ASR will initiate the Zero Sync right after it reboots, as described below in [Example 1](https://developer.afero.io/afPro-UART#UART-ZeroSync).
...
- [Example 1: Zero Sync](https://developer.afero.io/afPro-UART#UART-ZeroSync)
- [Example 2: Set Attribute](https://developer.afero.io/afPro-UART#UART-SetAttr)
- [Example 3: Update Attribute](https://developer.afero.io/afPro-UART#UART-UpdateAttr)
- [Example 4: Set Attribute with Collision](https://developer.afero.io/afPro-UART#UART-Collision)
...
![Zero Sync Overview](https://developer.afero.io/static/custom/images/UART-ZeroSync-Overview.png)](https://developer.afero.io/static/custom/images/UART-ZeroSync-Overview.png)
...
[*Click image to enlarge:*
![Zero Sync Request](https://developer.afero.io/static/custom/images/UART-ZeroSync-Request.png)](https://developer.afero.io/static/custom/images/UART-ZeroSync-Request.png)
...
[*Click image to enlarge:*
![Zero Sync Request](https://developer.afero.io/static/custom/images/UART-ZeroSync-Read.png)](https://developer.afero.io/static/custom/images/UART-ZeroSync-Read.png)
...
[*Click image to enlarge:*
![Zero Sync Acknowledge](https://developer.afero.io/static/custom/images/UART-ZeroSync-Ack.png)](https://developer.afero.io/static/custom/images/UART-ZeroSync-Ack.png)

At this point the master and slave are in sync. Neither one has anything to send.

### Example 2: Set Attribute

In this example, the Afero Cloud requests the MCU change the value of one of its attributes using a Set Attribute transaction. The MCU makes the change, resulting in an Update Attribute transaction (detailed in [Example 3: Update Attribute](https://developer.afero.io/afPro-UART#UART-UpdateAttr)).
...
[*Click image to enlarge:*
![Set MCU From Service Overview](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-Overview.png)](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-Overview.png)
...
[*Click image to enlarge:*
![Set MCU From Service Receive Request](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-RecvRequest.png)](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-RecvRequest.png)
...
[*Click image to enlarge:*
![Set MCU From Service ASR Response](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-ASRResponse.png)](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-ASRResponse.png)
...
[*Click image to enlarge:*
![Set MCU From Service Receive Acknowledge](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-RecvAck.png)](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-RecvAck.png)
...
[*Click image to enlarge:*
![Set MCU From Service Receive Data](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-RecvData.png)](https://developer.afero.io/static/custom/images/UART-SetMCUFromService-RecvData.png)
...
[*Click image to enlarge:*
![UART-Update ASR from MCU - Overview](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-Overview.png)](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-Overview.png)
...
[*Click image to enlarge:*
![UART - Update ASR from MCU - Sync Request](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-SyncRequest.png)](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-SyncRequest.png)
...
[*Click image to enlarge:*
![UART - Update ASR from MCU - Sync Acknowledge](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-SyncAck.png)](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-SyncAck.png)
...
[*Click image to enlarge:*
![UART - Update ASR from MCU - Send Data](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-SendData.png)](https://developer.afero.io/static/custom/images/UART-UpdateASRFromMCU-SendData.png)
