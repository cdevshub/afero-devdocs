...
- [Attribute Characteristics Affecting Change Behavior](https://developer.afero.io/AttrChangeRules#AttrCharac)
- [Change Rules for MCU Attributes](https://developer.afero.io/AttrChangeRules#ChangeRulesMCU)
- [Change Rules for ASR Attributes](https://developer.afero.io/AttrChangeRules#ChangeRulesHachi)
- [SET, GET, UPDATE Messages](https://developer.afero.io/AttrChangeRules#SetGetUpdate)
